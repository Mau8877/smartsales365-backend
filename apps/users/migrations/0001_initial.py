    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tienda', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='administradores', to='saas.tienda')),
            ],
        ),
        migrations.CreateModel(
            name='Vendedor',
            fields=[
                ...
                ('tienda', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='vendedores', to='saas.tienda')),
            ],
        ),
    ]
